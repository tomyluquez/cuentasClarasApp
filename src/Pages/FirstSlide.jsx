...
const FirstSlide = ({ slider, setSlider, setQuantity, setNameAccount }) => {
  ...
  const onSubmit = (data) => {
    ...
    setNameAccount(data.nameEvent);
    setSlider(slider + 1);
  };
  return (
    <form
      onSubmit={handleSubmit(onSubmit)}
      className="h-full flex flex-col items-center justify-center gap-80"
    >
      <div>
        <div className="form__group field group">
          ...
          {errors.nameEvent?.type === "required" && (
